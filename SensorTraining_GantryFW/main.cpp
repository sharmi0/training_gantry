...
const char* SERVER_ADDRESS = "192.168.1.201";    // Adress of the other Mbed (Mbed B)
...
float Fxc[6] = { 0.15794,   0.08758, 0.27177, -17.19775, -0.85008, 17.70688};
float Fyc[6] = {-1.02419, 20.04625,  0.57202,  -9.82367,  0.14649, -10.35906};
float Fzc[6] = {29.87590, -1.76261, 29.53467,  -1.18325, 29.85571, -0.22132};
float Mxc[6] = {-0.00105,  0.24201, -1.01876,  -0.07774,  1.03544, -0.13255}; // check that these rows are x,y,z too
float Myc[6] = { 1.19019, -0.07000, -0.58383,   0.22986, -0.58645, -0.21095};
float Mzc[6] = { 0.02796,  -0.66726,  0.01123,  -0.66305, 0.04073, -0.68719};
// bias terms
float bias[6];
...
int main()
{
    ...
    // Set up LTC chip
    LTC_chip.format(8, 0);
    LTC_chip.frequency(1000000); //10MHz? //60Mhz clock frequency 
    wait_ms(1);
